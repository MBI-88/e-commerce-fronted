...
function DashboardProfile() {
  ...
  return (
    ...
    {/* boton q da bateo */} 
    {/* como da bateo debo hacer un menu para movil o simplemente q seste disponibles en el menu general del navbar */}
      {/* <button
      ...
      <aside
        ...
        aria-label="Sidebar"
      >
        <div className="h-full px-3 py-4 mt-4 overflow-y-auto bg-opacity-30 dark:bg-gray-800">
